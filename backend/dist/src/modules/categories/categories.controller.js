...
const upsert_category_dto_1 = require("./dto/upsert-category.dto");
let CategoriesController = class CategoriesController {
    ...
    findAll(domaine) {
        if (domaine)
            return this.service.findByDomaine(domaine);
        return this.service.findAll();
    }
    findDomaines() { return this.service.findDomaines(); }
};
...
__decorate([
    (0, common_1.Get)('domaines'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CategoriesController.prototype, "findDomaines", null);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [upsert_category_dto_1.UpsertCategoryDto]),
    __metadata("design:returntype", void 0)
